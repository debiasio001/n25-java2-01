...
public class Duke extends Group {
	...
	public Duke() {
		...
		dukeImgVw.setPreserveRatio(true);// manter proporçao da imagem
		dukeImgVw.setY(10);
		//luva
		luvaImgVw.setFitWidth(40);
		luvaImgVw.setPreserveRatio(true);// manter proporçao da imagem
		luvaImgVw.setX(17);
